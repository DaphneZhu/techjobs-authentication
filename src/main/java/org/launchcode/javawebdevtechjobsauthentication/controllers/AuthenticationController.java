...
public class AuthenticationController {
    ...
    public String processRegistrationFom(@ModelAttribute @Valid RegisterFormDTO registerFormDTO,
        ...
        User existingUser = (User) userRepository.findByUsername(registerFormDTO.getUsername());

        if (existingUser !=null) {
            errors.rejectValue("username", "username.alreadyexisits", "A user with that username already exists" );
            model.addAttribute("title", "Register");
            return "register";
        }
